...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      AL: x0 => x0.readyState,
      AM: x0 => x0.stop(),
      AN: () => globalThis.Notification.requestPermission(),
      AO: x0 => x0.head,
      ...
      BL: (x0,x1) => { x0.binaryType = x1 },
      BM: (o,s,v) => o[s] = v,
      BN: (x0,x1) => ({vapidKey: x0,serviceWorkerRegistration: x1}),
      BO: (x0,x1) => { x0.text = x1 },
      ...
      CM: () => Symbol("jsBoxedDartObjectProperty"),
      CN: (x0,x1) => globalThis.firebase_messaging.getToken(x0,x1),
      CO: x0 => x0.trustedTypes,
      ...
      EL: (x0,x1,x2) => x0.insertBefore(x1,x2),
      EM: x0 => x0.state,
      EN: x0 => x0.analyticsLabel,
      EO: (x0,x1) => { x0.crossOrigin = x1 },
      F: () => new Error().stack,
      ...
      GJ: (o, p) => p in o,
      GK: x0 => x0.name,
      GL: x0 => x0.offsetHeight,
      GM: x0 => x0.stop(),
      GN: x0 => x0.body,
      GO: (x0,x1) => x0.querySelector(x1),
      ...
      HJ: x0 => x0.groups,
      HK: x0 => x0.result,
      HL: x0 => x0.offsetWidth,
      HM: (x0,x1,x2) => ({mimeType: x0,audioBitsPerSecond: x1,bitsPerSecond: x2}),
      HN: x0 => x0.title,
      HO: (x0,x1) => { x0.id = x1 },
      ...
      IK: x0 => x0.length,
      IL: x0 => x0.stopPropagation(),
      IM: (x0,x1) => new MediaRecorder(x0,x1),
      IN: x0 => x0.fcmOptions,
      IO: x0 => x0.remove(),
      ...
      ML: (x0,x1) => { x0.disabled = x1 },
      MM: (x0,x1) => x0.createMediaStreamSource(x1),
      MN: x0 => x0.collapseKey,
      MO: (x0,x1) => x0.createMediaElementSource(x1),
      N: (c) =>
      ...
      NL: (x0,x1) => { x0.scrollLeft = x1 },
      NM: x0 => x0.createAnalyser(),
      NN: x0 => x0.data,
      NO: x0 => x0.createGain(),
      ...
      PJ: (x0,x1) => { x0.src = x1 },
      PK: (x0,x1) => { x0.type = x1 },
      PL: (x0,x1) => { x0.disabled = x1 },
      PM: (x0,x1) => { x0.smoothingTimeConstant = x1 },
      ...
      QM: (x0,x1) => { x0.fftSize = x1 },
      QN: (x0,x1) => ({next: x0,error: x1}),
      QO: (x0,x1) => { x0.value = x1 },
      ...
      RM: (x0,x1) => { x0.onstop = x1 },
      RN: (x0,x1) => globalThis.firebase_messaging.onMessage(x0,x1),
      RO: x0 => x0.gain,
      ...
      SM: x0 => x0.arrayBuffer(),
      SN: x0 => globalThis.firebase_messaging.getMessaging(x0),
      SO: x0 => x0.code,
      T: x0 => new Promise(x0),
      ...
      TM: x0 => x0.type,
      TN: x0 => globalThis.firebase_core.getApp(x0),
      TO: x0 => x0.message,
      ...
      UL: x0 => x0.height,
      UM: x0 => x0.mimeType,
      UN: () => globalThis.firebase_core.getApp(),
      UO: x0 => x0.error,
      V: (constructor, args) => {
      ...
      VL: x0 => x0.width,
      VM: (x0,x1) => { x0.ondataavailable = x1 },
      VN: x0 => globalThis.firebase_messaging.deleteToken(x0),
      VO: x0 => x0.duration,
      W: x0 => new Array(x0),
      WB: o => {
        if (o === null || o === undefined) return 0;
      ...
      WM: x0 => x0.data,
      WN: x0 => x0.measurementId,
      WO: (x0,x1) => { x0.playbackRate = x1 },
      X: o => [o],
      ...
      XM: x0 => globalThis.MediaRecorder.isTypeSupported(x0),
      XN: x0 => x0.appId,
      XO: (x0,x1) => { x0.loop = x1 },
      Y: (o0, o1) => [o0, o1],
      YB: (t, s) => t.set(s),
      ...
      YM: x0 => x0.channelCount,
      YN: x0 => x0.messagingSenderId,
      YO: (x0,x1) => { x0.crossOrigin = x1 },
      Z: (o0, o1, o2) => [o0, o1, o2],
      ...
      lM: (x0,x1) => x0.getFloatTimeDomainData(x1),
      ...
      uJ: x0 => x0.firstChild,
      uK: () => new Array(),
      uL: x0 => globalThis.URL.revokeObjectURL(x0),
