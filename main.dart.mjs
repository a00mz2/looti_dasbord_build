...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      AI: x0 => x0.abort(),
      AJ: x0 => x0.decode(),
      AK: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      AL: (x0,x1) => { x0.src = x1 },
      AM: x0 => x0.userAgent,
      AN: x0 => x0.fftSize,
      ...
      CK: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      ...
      KI: x0 => x0.status,
      KJ: x0 => x0.frameCount,
      KK: x0 => globalThis.URL.createObjectURL(x0),
      ...
      YI: x0 => x0.disabled,
      YJ: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      ...
      aL: () => globalThis.Notification.requestPermission(),
      ...
      iI: (a, i) => a.splice(i, 1),
      iJ: (x0,x1,x2,x3,x4) => ({dir: x0,lang: x1,body: x2,tag: x3,icon: x4}),
      iK: (x0,x1) => x0.item(x1),
      iL: x0 => x0.height,
      iM: x0 => x0.mimeType,
      ...
      jI: a => a.pop(),
      jJ: (x0,x1) => new Notification(x0,x1),
      jK: () => new FileReader(),
      jL: x0 => x0.width,
      ...
      pJ: () => globalThis.Notification.permission,
      pK: x0 => x0.files,
